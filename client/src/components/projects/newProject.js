      ...
      <div>
        ...
        {!loading && (
          ...
          >
            ...
            <Row gutter={16} className="row">
              <Col sm={12} md={12} lg={12} xl={splWidth}>
                <Form.Item label={dictionary.SELECT_MANAGER}>
                  {getFieldDecorator('managerId', {
                    ...
                    >
                      <Option disabled value="">{dictionary.PLEASE_SELECT}</Option>
                      {manager}
                    </Select>
                  )}
                </Form.Item>
              ...
              <Col sm={12} md={12} lg={12} xl={splWidth}>
                <Form.Item label={dictionary.SELECT_CLIENT}>
                ...
                {currentProject.id && (
                <Col sm={12} md={12} lg={12} xl={splWidth}>
                  <Form.Item label={dictionary.SELECT_STATUS}>
                    {getFieldDecorator('projectCompleted', {
                      ...
                      <Select
                        showSearch
                        placeholder={dictionary.SELECT_STATUS}
                        optionFilterProp="children"
                        filterOption={(input, option) =>
                          option.props.children.toLowerCase().indexOf(input.toLowerCase()) >= 0}
                      >
                        <Option value="">{dictionary.SELECT_STATUS}</Option>
